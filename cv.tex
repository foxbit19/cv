...
\newcommand{\skillCircle}[2]{
    \begin{pspicture}(2,2)
	    \cnodeput[linecolor=mygray](1,1){E}{\ralewayb{#1}}
    	\pscircle[linecolor=skillbg,linewidth=2pt](1,1){1}
    	\psarc[linecolor=dark,linewidth=2pt](1,1){0.97}{90}{#2}
    \end{pspicture}
}
...
\begin{textblock}{58.5}(6,7.7)
    ...
    Insert here a description of yourself. Who you are?
    ...
    \begin{tabular}{rl}
        \contactline{Phone}{123456789} \\
        \contactline{Email}{your@beautiful.email} \\
        \contactline{Website}{\href{https://your.site}{your.site}} \\
        \contactline{GitHub}{\href{https://github.com/your-github}{@your-github}} \\
        \contactline{LinkedIn}{\href{https://linkedin.com/in/your-linkedin}{/in/your-linkedin}}
    \end{tabular}
    ...
    \section{Languages}
    	\vspace{20pt}
		\begin{tabular}{rl}
			\skillCircle{italian}{450} 
			\skillCircle{english}{210}
		\end{tabular}
